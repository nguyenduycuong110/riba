            ...
            <div class="panel-body">
                ...
                <div class="chilren-list-post mt50 featured-post">
                    ...
                    <div class="panel-body">
                        ...
                        @php
                        // Lưu lại paginator gốc để dùng cho pagination
                        $postsPaginator = $posts;
                        // Đếm số lượng items thực sự hiển thị (bỏ qua 5 item đầu)
                        $displayedCount = 0;
                        @endphp
                        ...
                        @if($displayedCount > 0 && method_exists($postsPaginator, 'hasPages') && $postsPaginator->hasPages())
                        <div class="model-paginate mt30 mb30 uk-flex uk-flex-center">
                            @include('frontend.component.pagination', ['model' => $postsPaginator])
                        </div>
                        @endif
                        @else
