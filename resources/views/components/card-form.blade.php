...
<div class="panel-form" id="panel-form">
    <div class="form-area">
        ...
        <div class="apply-form-4__thumb__bg" style="background-image: url({{ !empty($system['homepage_card_bg']) ? $system['homepage_card_bg'] : 'https://wp.rrdevs.net/routex/wp-content/uploads/2024/10/thumb-bg.jpg' }});"></div>
