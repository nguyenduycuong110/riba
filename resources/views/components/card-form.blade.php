                        ...
                        <div class="form-heading">
                            ...
                            <div class="form-container">
                                <div class="uk-grid uk-grid-medium mb20">
                                    <div class="uk-width-large-1-2">
                                        <div class="form-row">
                                            <input class="input-text form-control" value="" placeholder="Họ Tên *" type="text">
                                        </div>
                                    </div>
                                    <div class="uk-width-large-1-2">
                                        <div class="form-row">
                                            <input class="input-text form-control" value="" placeholder="Email *" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="uk-grid uk-grid-medium mb20">
                                    <div class="uk-width-large-1-2">
                                        <div class="form-row">
                                            <input class="input-text form-control" value="" placeholder="Số điện thoại *" type="text">
                                        </div>
                                    </div>
                                    <div class="uk-width-large-1-2">
                                        <div class="form-row">
