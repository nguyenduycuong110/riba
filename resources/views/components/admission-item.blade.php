    ...
    <div class="info">
        ...
        <div class="admission-extend">
            ...
            <div class="extend-item">
                ...
                <span>Loại Học bổng: {{ $scholar?->first()?->scholar_catalogues?->first()?->languages?->first()?->pivot?->name ?? '' }}</span>
            </div>
            <div class="extend-item">
                <svg class="text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2" stroke-linecap="round" stroke-linejoin="round" stroke="currentColor" stroke-width="1.5"></path>
                </svg>
