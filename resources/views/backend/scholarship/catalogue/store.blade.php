...
@php
    $url = ($config['method'] == 'create') ? route('scholarship.catalogue.store') : route('scholarship.catalogue.update', $scholarshipCatalogue->id);
@endphp
                                ...
                                <div class="form-row">
                                    @if($config['method'] == 'create')
                                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb5">
                                            ...
                                            <button type="button" class="add-item">+ Thêm nhóm học bổng</button>
                                        </div>
                                        <input 
                                            type="text"
                                            name="name[]"
                                            value="{{ old('name.0', '') }}"
                                            class="form-control"
                                            placeholder="Nhập nhóm học bổng"
                                            autocomplete="off"
                                        >
                                    ...
                                    @else
                                        ...
                                        <input 
                                            type="text"
                                            name="name"
                                            value="{{ old('name', isset($scholarshipCatalogue) ? $scholarshipCatalogue->name : '') }}"
                                            class="form-control"
                                            placeholder="Nhập nhóm học bổng"
                                            autocomplete="off"
                                        >
