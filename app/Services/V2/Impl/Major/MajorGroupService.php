...
use App\Repositories\Major\MajorGroupRepo;
...
class MajorGroupService extends BaseService {
    ...
    public function dropdown(){
        $this->initNestedset(table: 'major_groups', key: 'major_group_id'); 
    ...
    protected function afterSave(): static {
        $this->handleRouter(controller: 'MajorGroupController');
        $this->initNestedset(table: 'major_groups', key: 'major_group_id'); 
        $this->nestedSet();
        return $this;
    }
