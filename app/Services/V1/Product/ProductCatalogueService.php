 ...
 */
class ProductCatalogueService extends BaseService
{
    ...
    public function getChildren(){
        ...
        if(count($originalCategory)){
            foreach($originalCategory as $category){
                ...
                $category->setAttribute('direct_product_count', $directProductCount);
                $category->setAttribute('total_product_count', $totalProducts);
            }
        }
